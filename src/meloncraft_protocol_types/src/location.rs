...
impl ProtocolType for NetworkLocation {
    fn net_serialize(&self) -> Vec<u8> {
        let long: i64 = ((i64::from(self.0.x) & 0x03FF_FFFF) << 38)
...
mod tests {
    ...
    fn location_serialization() {
        ...
        let expected: u64 =
            0b_0100_0110_0000_0111_0110_0011_0010_1100_0001_0101_1011_0100_1000_0011_0011_1111;
        assert_eq!(serialized_long, expected);
    }
    #[test]
    fn location_deserialization() {
        use super::*;
        let serialized_long: u64 =
            0b_0100_0110_0000_0111_0110_0011_0010_1100_0001_0101_1011_0100_1000_0011_0011_1111;
