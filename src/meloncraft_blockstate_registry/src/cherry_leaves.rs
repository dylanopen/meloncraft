...
impl BlockState for CherryLeaves {
    fn to_id(&self) -> i32 {
        ...
        if self.r#waterlogged == true && self.r#persistent == true && self.r#distance == 7 {
            return 416;
        }
        ...
        if self.r#waterlogged == false && self.r#distance == 4 && self.r#persistent == true {
            return 405;
        }
        ...
        if self.r#persistent == false && self.r#waterlogged == true && self.r#distance == 5 {
            return 410;
        }
        ...
        if self.r#waterlogged == true && self.r#distance == 4 && self.r#persistent == false {
            return 406;
        }
        if self.r#waterlogged == true && self.r#distance == 1 && self.r#persistent == true {
            return 392;
        }
        if self.r#persistent == true && self.r#waterlogged == false && self.r#distance == 5 {
            return 409;
        }
        if self.r#waterlogged == false && self.r#persistent == false && self.r#distance == 5 {
            return 411;
        }
        if self.r#persistent == true && self.r#waterlogged == true && self.r#distance == 6 {
            return 412;
        }
        if self.r#distance == 1 && self.r#waterlogged == true && self.r#persistent == false {
            return 394;
        }
        if self.r#distance == 7 && self.r#waterlogged == false && self.r#persistent == true {
            return 417;
        }
        if self.r#persistent == false && self.r#waterlogged == false && self.r#distance == 1 {
            return 395;
        }
        if self.r#persistent == false && self.r#waterlogged == false && self.r#distance == 3 {
            return 403;
        }
