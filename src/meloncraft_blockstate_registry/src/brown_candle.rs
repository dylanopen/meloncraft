...
impl BlockState for BrownCandle {
    fn to_id(&self) -> i32 {
        if self.r#lit == false && self.r#waterlogged == false && self.r#candles == 1 {
            return 23105;
        }
        ...
        if self.r#candles == 2 && self.r#lit == true && self.r#waterlogged == true {
            return 23106;
        }
        if self.r#candles == 2 && self.r#lit == true && self.r#waterlogged == false {
            return 23107;
        }
        if self.r#waterlogged == false && self.r#candles == 1 && self.r#lit == true {
            return 23103;
        }
        ...
        if self.r#lit == true && self.r#waterlogged == false && self.r#candles == 4 {
            return 23115;
        }
        if self.r#waterlogged == true && self.r#candles == 4 && self.r#lit == true {
            return 23114;
        }
        if self.r#candles == 3 && self.r#lit == false && self.r#waterlogged == true {
            return 23112;
        }
        if self.r#lit == false && self.r#waterlogged == false && self.r#candles == 3 {
            return 23113;
        }
        ...
        if self.r#candles == 3 && self.r#lit == true && self.r#waterlogged == true {
            return 23110;
        }
        if self.r#waterlogged == false && self.r#lit == true && self.r#candles == 3 {
            return 23111;
        }
