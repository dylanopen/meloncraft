//! Crate containing data types for representing entity components, resources and messages related
//! to their state and events, for the [Meloncraft](https://github.com/dylanopen/meloncraft).
...
//!
//! ## Pure `type` crate
//! `meloncraft_entity` is a *type* crate. This means it doesn't hold any systems or stateful
