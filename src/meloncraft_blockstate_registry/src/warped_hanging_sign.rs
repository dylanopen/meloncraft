...
impl BlockState for WarpedHangingSign {
    fn to_id(&self) -> i32 {
        ...
        if self.r#waterlogged == false && self.r#rotation == 1 && self.r#attached == true {
            return 6285;
        }
        ...
        if self.r#attached == false && self.r#rotation == 15 && self.r#waterlogged == true {
            return 6344;
        }
        ...
        if self.r#rotation == 7 && self.r#attached == true && self.r#waterlogged == true {
            return 6296;
        }
        ...
        if self.r#waterlogged == true && self.r#rotation == 0 && self.r#attached == false {
            return 6314;
        }
        if self.r#waterlogged == true && self.r#attached == true && self.r#rotation == 15 {
            return 6312;
        }
        if self.r#waterlogged == false && self.r#rotation == 11 && self.r#attached == false {
            return 6337;
        }
        ...
        if self.r#waterlogged == true && self.r#attached == false && self.r#rotation == 1 {
            return 6316;
        }
