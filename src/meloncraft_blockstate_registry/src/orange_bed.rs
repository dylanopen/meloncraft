...
impl BlockState for OrangeBed {
    fn to_id(&self) -> i32 {
        if self.r#part == Part::Head && self.r#occupied == true && self.r#facing == Facing::South {
            return 1751;
        }
        ...
        if self.r#part == Part::Head && self.r#occupied == false && self.r#facing == Facing::East {
            return 1761;
        }
        if self.r#facing == Facing::North && self.r#occupied == false && self.r#part == Part::Head {
            return 1749;
        }
        if self.r#facing == Facing::South && self.r#part == Part::Foot && self.r#occupied == true {
            return 1752;
        }
        ...
        if self.r#occupied == true && self.r#facing == Facing::East && self.r#part == Part::Foot {
            return 1760;
        }
