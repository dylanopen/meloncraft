...
impl BlockState for GrayBed {
    fn to_id(&self) -> i32 {
        ...
        if self.r#facing == Facing::South && self.r#part == Part::Head && self.r#occupied == false {
            return 1849;
        }
        if self.r#occupied == true && self.r#facing == Facing::South && self.r#part == Part::Head {
            return 1847;
        }
        if self.r#part == Part::Head && self.r#facing == Facing::West && self.r#occupied == false {
            return 1853;
        }
        ...
        if self.r#facing == Facing::East && self.r#part == Part::Head && self.r#occupied == true {
            return 1855;
        }
        if self.r#occupied == false && self.r#part == Part::Foot && self.r#facing == Facing::South {
            return 1850;
        }
        if self.r#part == Part::Foot && self.r#facing == Facing::East && self.r#occupied == true {
            return 1856;
        }
        ...
        if self.r#occupied == true && self.r#facing == Facing::West && self.r#part == Part::Foot {
            return 1852;
        }
