...
impl BlockState for BirchButton {
    fn to_id(&self) -> i32 {
        ...
        if self.r#facing == Facing::South && self.r#face == Face::Ceiling && self.r#powered == false
        {
            return 10540;
        }
        ...
        if self.r#face == Face::Ceiling && self.r#facing == Facing::North && self.r#powered == false
        {
            return 10538;
        }
        ...
        if self.r#facing == Facing::West && self.r#powered == false && self.r#face == Face::Ceiling
        {
            return 10542;
        }
        ...
        if self.r#face == Face::Ceiling && self.r#powered == true && self.r#facing == Facing::North
        {
            return 10537;
        }
        if self.r#powered == false && self.r#face == Face::Ceiling && self.r#facing == Facing::East
        {
            return 10544;
        }
        if self.r#facing == Facing::East && self.r#powered == true && self.r#face == Face::Wall {
            return 10535;
        }
        ...
        if self.r#facing == Facing::West && self.r#face == Face::Ceiling && self.r#powered == true {
            return 10541;
        }
        ...
        if self.r#facing == Facing::East && self.r#face == Face::Wall && self.r#powered == false {
            return 10536;
        }
        if self.r#facing == Facing::South && self.r#face == Face::Wall && self.r#powered == true {
            return 10531;
        }
        if self.r#face == Face::Floor && self.r#facing == Facing::South && self.r#powered == false {
            return 10524;
        }
        if self.r#face == Face::Wall && self.r#powered == false && self.r#facing == Facing::West {
            return 10534;
        }
