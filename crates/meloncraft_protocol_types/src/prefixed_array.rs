...
impl<T: ProtocolType> ProtocolType for PrefixedArray<T> {
    ...
    fn net_deserialize(data: &mut Vec<u8>) -> Result<Self, ()> {
        ...
        return Ok(PrefixedArray(values));
    }
}
...
mod tests {
    ...
    #[test]
    fn serialize_prefixed_array_string() {
    ...
    #[test]
    fn prefixed_array_deserialize_empty() {
        let mut data = vec![0];
        let deserialized = PrefixedArray::<Byte>::net_deserialize(&mut data).unwrap();
    ...
    #[test]
    fn single_item_prefixed_array_serialize() {
    ...
    #[test]
    fn single_item_prefixed_array_deserialize() {
    ...
    #[test]
    fn empty_prefixed_array_serialize() {
    ...
    #[test]
    fn empty_prefixed_array_deserialize() {
        let mut data = vec![0];
        let deserialized = PrefixedArray::<Byte>::net_deserialize(&mut data).unwrap();
        let expected = PrefixedArray(vec![]);
        assert_eq!(deserialized.0, expected.0);
